...
def show_static_page():
    ...
    if file_uploaded:
        ...
        COUNTABLE_THRESHOLD = st.sidebar.slider("Countable threshold:", min_value=1, max_value=30, value=10, 
                                key="count_threshold", 
        ...
        data, err_date = convert2datetime(data=data, datetime_var=datetime_var)
        ...
        #                           PLOTTING SECTION 
        ###########################################################################
        from static_plot_1 import plot_scatter, plot_line, plot_bar, plot_hist
